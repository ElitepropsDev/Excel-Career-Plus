...
const ProgramPreview = () => {
  return (
    ...
    className="py-16 px-4 sm:px-12 lg:px-24 xl:px-40 bg-white dark:bg-gray-900 rounded-2xl shadow-lg">
      ...
      {/* Benefits Strip */}
      {/* Benefits Strip - Centered with Aligned Bullets */}
      <div className="mb-12 p-6 bg-[#212EA0] text-white rounded-xl shadow-md">
        <div className="flex flex-col sm:flex-row justify-center items-center gap-5 sm:gap-12">
          
          {/* Wrapper to keep dots aligned but the group centered on mobile */}
          <div className="flex flex-col sm:flex-row gap-5 sm:gap-12 items-start sm:items-center">
            
            <div className="flex items-center gap-3">
              <div className="shrink-0 w-2 h-2 bg-[#EC4899] rounded-full"></div>
              <h4 className="font-medium text-base sm:text-lg tracking-wide uppercase">Global Exposure</h4>
            </div>
            
            <div className="flex items-center gap-3">
              <div className="shrink-0 w-2 h-2 bg-[#10B981] rounded-full"></div>
              <h4 className="font-medium text-base sm:text-lg tracking-wide uppercase">Career Boost</h4>
            </div>

            <div className="flex items-center gap-3">
              <div className="shrink-0 w-2 h-2 bg-[#F472B6] rounded-full"></div>
              <h4 className="font-medium text-base sm:text-lg tracking-wide uppercase">Certification</h4>
            </div>
