...
const ContactUs = () => {
  ...
  className="
    block
    w-full
    max-w-[260px]   /* smaller button */
    mx-auto
    flex
    items-center
    justify-center
    gap-1.5         /* tighter icon/text spacing */
    bg-[#25D366]
    hover:bg-[#1ebe5b]
    text-white
    font-medium
    px-3            /* reduced left & right padding (mobile) */
    py-2.5          /* slightly shorter height */
    rounded-full
    transition-all
    text-sm
    mb-6
    sm:px-6         /* full-size padding for desktop */
    sm:gap-2
    sm:py-3
  "
>
